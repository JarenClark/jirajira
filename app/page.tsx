...
export default async function Index() {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div className="flex flex-col gap-14 opacity-0 max-w-4xl px-3 py-16 lg:py-24 text-foreground">
        <div className="flex flex-col items-center mb-4 lg:mb-12">
          ...
          <h1 className="sr-only123">Supabase and Next.js Starter Template</h1>
